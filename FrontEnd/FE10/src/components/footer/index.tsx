...
const SERVICE = [
  ...
  { id: 2, title: 'Fvenue Mall', path: '/' },
  { id: 3, title: 'Fvenue Blog', path: '/' },
  { id: 4, title: 'Contact Us', path: '/' },
  { id: 5, title: 'Warranty Policy', path: '/' },
]

const ABOUT = [
  { id: 1, title: 'About Us', path: '/help-center' },
  { id: 2, title: 'Fvenue Policies', path: '/product' },
  { id: 3, title: 'Seller Centre', path: '/access' },
  { id: 4, title: 'Fvenue Ambassador Programme', path: '/contact' },
...
const ADDRESS = [
  ...
  { id: 2, title: 'Fvenue@gmail.com', path: '/#' },
...
const categories: Category[] = [
  ...
  { title: 'ABOUT FVENUE', items: ABOUT },
  { title: 'OTHER EF TOURS BRANDS', items: OETB },
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <span className="self-center whitespace-nowrap text-3xl font-extrabold text-white">FVenue</span>
            </Link>
            <div className="mt-6 text-center">
              <A items={ADDRESS} />
            </div>
            <div className="mt-8 pr-14 text-center text-white">
              &copy; {currentYear} <a href="https://material-tailwind.com/">Fvenue</a>. All Rights Reserved.
            </div>
          </div>
          <div className="w-full">
            <div className="grid grid-cols-2 gap-8 px-4 py-2 md:grid-cols-4">{categories.map(renderCategory)}</div>
          </div>
        </div>
        <div className="bottom-30 left-10 flex flex-row gap-5">
