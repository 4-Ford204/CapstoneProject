...
function Header() {
  return (
    <div className="h-[5rem]  bg-gray-100 md:px-12">
      <div className="mx-auto ml-10 flex h-full items-center justify-between bg-gray-100">
        ...
        <div className="flex items-center">
          ...
          <Link to={'/recent'} className="mr-4 flex items-center text-black hover:text-gray-400">
